...
\lstdefinelanguage{Protelis}{
    ...
    morecomment=[l]{//},
    morecomment=[s]{/*}{*/},
    keywords={def, else, import, mux, sumHood, PlusSelf, let, rep, env, self, pi, if, e, public, NaN, false, true, minHood, maxHood, nbrRange, nbr, Infinity, share},
    frame=no,
    breaklines=true,
    captionpos=b,
    keepspaces=true,
...
\lstdefinelanguage{scafi}{
  ...
  keywords=[2]{rep,nbr,foldhood,@@,share},
...
\lstdefinelanguage{fscafi}{
  ...
  keywords=[2]{rep,nbr,foldhood,branch,@@,share},
...
\lstdefinelanguage{hfc}{
    ...
    morecomment=[l]{//},
    morecomment=[s]{/*}{*/},
    keywords={def, let, rep, if, nbr, share},
    frame=no,
    breaklines=true,
    captionpos=b,
    keepspaces=true,
...
\author{Lorenzo Testa \\[0.8cm] Supervisor: Prof. Ferruccio Damiani \\ Co-supervisors: Dr. Giorgio Audrito, Dr. Danilo Pianini \\ Opponent: Dr. Gianluca Torta \\[0.8cm] Corso di Laurea Magistrale in Informatica \\ Università degli Studi di Torino \\ a.y. 2019 / 2020}
